...
with open("input2.txt", "r") as file:
    # Parse input to list of lists with ints like [[l, w, h], [l, w, h], ...]
...
def shortest_distance(l, w, h):
    return min([2*l+2*w, 2*h+2*l, 2*w+2*h])
...
def total_area(dimensions):
    ...
    for dim in dimensions:
        ...
        area += surface_area(l, w, h) + area_smallest_side(l, w, h)
    return area


def total_feet_ribbon(dimensions):
    feet = 0
    for dim in dimensions:
        l, w, h = dim[0],  dim[1], dim[2]
        feet += shortest_distance(l, w, h) + volume(l, w, h)
    return feet


if __name__ == "__main__":
    print("The elves need to order %s square feet of wrapping paper" %
          total_area(dimensions))
    # The elves need to order 1586300 square feet of wrapping paper

    print("The elves need to order %s feet of ribbon" %
          total_feet_ribbon(dimensions))
    # The elves need to order 3737498 feet of ribbon
